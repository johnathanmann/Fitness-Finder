...
$('#leveregeMachine').click(function (){
    var selection = 'leveragemachine';
// Get body part exercise list
const settings = {
    "async": true,
    "crossDomain": true,
...
// Find body part: Trap Bar
$('#trapBar').click(function (){
    var selection = 'trap%20bar';
// Get body part exercise list
const settings = {
    "async": true,
    "crossDomain": true,
...
$.ajax(settings).done(function (response) {
    ...
    $.ajax(settings).done(function (response) {
        ...
        heart.click(function (){
            ...
            var card = $('.bodyCard').html();
            console.log(card);
            localStorage.setItem('trapBar', JSON.stringify(card));
        });
    });
});
